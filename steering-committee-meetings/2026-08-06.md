...
- **Summary:** The RFC proposes an org-wide documentation philosophy that top level project provide a project specific mdBook
  for project documentation. And that project specific documentation should not be hosted in the docuementation repo. 
- **Supporting links:**
